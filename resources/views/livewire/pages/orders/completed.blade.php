              ...
              <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      <tr>
                          ...
                          <th scope="col" class="px-4 py-3">Order Name</th>
                          <th scope="col" class="px-4 py-3">Order Cost</th>
                  ...
                  <tbody>
                    @foreach ($orders as $order)
                      ...
                      <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td class="px-4 py-2">
                              <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{$order->phone }}</span>
                          </td>
                          <td class="px-4 py-2 font-medium uppercase text-gray-900 whitespace-nowrap dark:text-white">
                              <div class="flex items-center">
                                  
                                  {{$order->order  }}
                              </div>
                          </td>
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$order->order_name  }}</td>
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ number_format($order->work_cost)  }}</td>
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            {{ number_format($order->expenses)  }}
                          </td>
                          ...
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$order->created_at   }}</td>
                          <td class="px-4 py-2">
