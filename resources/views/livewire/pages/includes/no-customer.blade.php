            ...
            <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white text-center" colspan="10">
                                <img src="{{ asset('assets/noorder.png') }}" alt="No Orders" class="mx-auto w-40 h-40 sm:w-60 sm:h-60">
                                <p class="mt-2 text-gray-600 font-extrabold dark:text-gray-400">There are no orders</p>
                            </td>
                        </tr>
                    </tbody>
